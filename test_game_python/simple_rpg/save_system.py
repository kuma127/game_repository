...
class SaveSystem:
    ...
    def save_game(self, player: Character, slot=1):
        """
        ゲームをセーブする
        ...
        try:
            ...
            save_data = {
                ...
                "player": {
                    ...
                    "equipment_inventory": [eq.id for eq in player.equipment_inventory],
                    "status_effects": player.status_effects.to_dict(),  # 追加
                },
            }
